		...
		<header>
			...
			<c:if test="${not empty sessionScope.noUtilisateur}">
				<div>
					...
					vous êtes =
					<c:out value="${sessionScope.administrateur}" />
				</div>
			</c:if>
		</header>
			...
			<div>
				<form action="accueil" method="POST">
					...
					<select name="categorieRecherche" id="categorieRecherche">
						...
						</c:if> <input type="submit" value="Rechercher">
				</form>
			</div>
					...
					<c:forEach var="article" items="${articlesvendus}">
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							...
							<div class="card" style="width: 18rem;">
								<img src="images/photo-enchere.jpg" class="card-img-top" alt="Photo Open-source d'une enchère">
								<div class="card-body">
