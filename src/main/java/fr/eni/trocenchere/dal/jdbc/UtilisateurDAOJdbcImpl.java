...
public class UtilisateurDAOJdbcImpl implements UtilisateurDAO {
    private final static String SELECT_CONNEXION = "SELECT no_utilisateur, pseudo, nom, prenom, email, mot_de_passe, credit, administrateur FROM UTILISATEURS WHERE email=? AND mot_de_passe=?";
